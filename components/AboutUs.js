        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-10 transition-transform duration-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-lg md:text-xl mb-4 opacity-90">
              At [Company Name], we believe in building more than just structures; we build relationships, trust, and a better future for our communities.
            </p>
            <p className="mb-6 text-lg md:text-xl opacity-80">
              With over [X years] of experience in the construction industry, our dedicated team is committed to delivering top-notch quality, innovative solutions, and sustainable practices in every project we undertake.
            </p>
            ...
            <button className="px-6 py-2 bg-primary hover:bg-secondary text-white font-semibold rounded-lg shadow-lg transition duration-300 transform hover:scale-105">
              Learn More
            </button>
          </div>
          ...
          <div className="relative h-64 md:h-full overflow-hidden rounded-lg shadow-lg">
            <Image
              src="/team-image.jpg" // Replace with your team image
              alt="Our Team"
              layout="fill"
              objectFit="cover"
